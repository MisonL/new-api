...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/oauth/desktop/start", middleware.CriticalRateLimit(), controller.StartDesktopOAuth)
		apiRouter.GET("/oauth/desktop/poll", middleware.DesktopOAuthPollRateLimit(), controller.PollDesktopOAuth)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invitation_records", controller.GetInvitationRecords)
				selfRoute.GET("/gift_codes", controller.ListGiftCodes)
				selfRoute.POST("/gift_codes", middleware.CriticalRateLimit(), controller.CreateGiftCode)
				selfRoute.GET("/gift_codes/:code", middleware.SearchRateLimit(), controller.GetGiftCode)
				selfRoute.POST("/gift_codes/:code/receive", middleware.CriticalRateLimit(), controller.ReceiveGiftCode)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/npm_version_options", middleware.CriticalRateLimit(), controller.GetChannelNpmVersionOptions)
			channelRoute.GET("/npm_version_options/diagnostics", middleware.CriticalRateLimit(), controller.GetChannelNpmVersionDiagnostics)
			channelRoute.POST("/npm_version_options/refresh", middleware.CriticalRateLimit(), controller.RefreshChannelNpmVersionOptions)
			channelRoute.GET("/priorities", controller.GetTopChannelPriorities)
			...
			channelRoute.PUT("/priorities", controller.UpdateChannelPriorities)
