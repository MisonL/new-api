...
> 项目入口：[仓库 README](https://github.com/MisonL/new-api/blob/main/README.md)
...
- [仓库 README](https://github.com/MisonL/new-api/blob/main/README.md)
- [当前部署文档](https://github.com/MisonL/new-api/blob/main/docs/installation/BT.md)
- [项目 Release](https://github.com/MisonL/new-api/releases)
- [GitHub 仓库](https://github.com/MisonL/new-api)
...
> 注意：密钥为环境变量 `SESSION_SECRET`，请务必设置！
