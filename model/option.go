...
func InitOptionMap() {
	...
	common.OptionMap["GroupModelRouteHelperEnabled"] = strconv.FormatBool(common.GroupModelRouteHelperEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "GroupModelRouteHelperEnabled":
			common.GroupModelRouteHelperEnabled = boolValue
