...
- Browser callback URL fallback only reads X-Forwarded-* from trusted private or loopback proxies and can be disabled with `CustomOAuthTrustForwardedHeaders`
...
- 🔄 **OpenAI Compatible ⇄ OpenAI Responses** - Supported with configurable policy rules in console settings
