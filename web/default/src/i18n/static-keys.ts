...
export const STATIC_I18N_KEYS = [
  ...
  'Anthropic Beta/Version Passthrough',
  'AWS Bedrock Claude Beta Header',
  'AWS Bedrock Remove Input Examples',
  'Codex CLI Dynamic Headers Passthrough',
  'Codex Desktop Dynamic Headers Passthrough',
  'Claude Code Header Passthrough',
  'Droid CLI Header Passthrough',
  'Examples and Starting Points',
  'Example: Legacy Field Object',
  'Example: Set Temperature by Model',
  'Gemini CLI Header Passthrough',
  'OpenAI SDK Metadata Passthrough',
